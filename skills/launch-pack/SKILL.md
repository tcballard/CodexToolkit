...
- Use `readme-front-door` for the repository README's opening explanation, primary command, proof, demo placement, and justified badges. Supply verified claims and approved assets.
